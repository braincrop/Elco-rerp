  ...
  return (
    <motion.button
      ...
      className={joinClasses(
        "vvm-slot",
        selected && "vvm-slot-selected",
        !slot.active && "vvm-slot-disabled"
      )}
    >
      ...
      <div className="vvm-stock-bar mt-2">
        <div
          className={lowStock ? "vvm-stock-fill-low" : "vvm-stock-fill-ok"}
      ...
      <div className="row g-3 mt-2">
        ...
        <div className="col-6">
          <button
            ...
            className="vvm-btn vvm-btn-soft w-100 py-3"
          >
            <Wrench size={17} /> Test
          </button>
        </div>
...
function AdminEditor({ slot, onSave, onClose }) {
  ...
  return (
    <motion.div
      ...
      className="vvm-editor p-4 p-md-5"
    >
      ...
      <div className="row g-3">
        ...
        <div className="col-md-6">
          ...
          <input
            type="number"
            value={form.motorNo}
            onChange={(e) => update("motorNo", Number(e.target.value))}
            className="vvm-input"
          />
        </div>
        <div className="col-md-6">
              ...
              <div className="d-grid gap-3 mt-4">
                {steps.map((step, index) => {
                  ...
                  return (
                    <div
                      key={step}
                      className={joinClasses("vvm-step", done && "vvm-step-done", active && "vvm-step-active")}
                    >
                      {done ? (
...
export default function VirtualVmSplash() {
    ...
    setTimeout(() => {
      setSlots((prev) => {
        const updated = prev.map((slot) =>
          slot.code === selectedSlot.code ? { ...slot, stock: Math.max(0, slot.stock - 1) } : slot
        );
          ...
          <section className="col-xl-9">
            <div className="vvm-machine-shell p-3 p-md-4">
              <div className="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-4">
                ...
                <div className="badge rounded-pill border border-secondary text-secondary bg-black bg-opacity-25 px-3 py-2">
                  Machine ID: VM-001
                </div>
              </div>

              <div className="vvm-glass-outer p-3 p-md-4">
