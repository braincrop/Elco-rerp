      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ background: '#1e293b', padding: '20px', borderRadius: '20px' }}>
            ...
            <h2>
              {paymentLogs.reduce((sum, item) => sum + item.successfulItemCount, 0)}
            </h2>
          </div>
          ...
          <div style={{ background: '#1e293b', padding: '20px', borderRadius: '20px' }}>
            ...
            <h2>
              {paymentLogs.reduce((sum, item) => sum + item.unsuccessfulItemCount, 0)}
            </h2>
          </div>
          ...
          <div style={{ background: '#1e293b', padding: '20px', borderRadius: '20px' }}>
            ...
            <h2>
              {paymentLogs.reduce((sum, item) => sum + item.total, 0)}
            </h2>
          </div>
        </div>
          ...
          <tbody>
            {paymentLogs.map((item, index) => (
              <tr key={item.uuId}>
                ...
                <td className="text-white">
                  {item.buyerDisplay?.personalInfoSummary}
                </td>
                ...
                <td className="text-white">
                  {item.erpSyncStatus === null ? 'Not Synced' : item.erpSyncStatus}
                </td>
        ...
        <Row>
          ...
          <Col md="6">
            <FormGroup>
              ...
              <Input type="select" name="HasSuccessfulItems" value={filters.HasSuccessfulItems} onChange={handleChange} style={{ background: 'transparent' }}>
           ...
           <Col md="6">
            <FormGroup>
              ...
              <Input type="select" name="HasUnsuccessfulItems" value={filters.HasUnsuccessfulItems} onChange={handleChange} style={{ background: 'transparent' }}>
                <option value="">-- Any Sale Status --</option>
                <option value="true" className="custom-text">
                  true
                </option>
